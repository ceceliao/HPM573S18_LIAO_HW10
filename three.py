...
class Patient:
    ...
    def simulate(self, sim_length):
        ...
        while self.healthstat!=3 and k  < sim_length:
            ...
            trans_probs = data.TRANS[self._therapies][self.healthstat]
            ...
            cost=data.TRANS_COST[self._therapies][self.healthstat]
            utility=data.TRANS_UTILITY[self._therapies][self.healthstat]
...
class Cohort:
    ...
    def simulate(self):
        for a in range(self._initial_pop_size):
            ...
            self._survivaltime.append(patient.get_survival_time())
